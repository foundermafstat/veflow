...
export const BorderLoadingIndicator = ({ children }: { children: ReactNode }) => {
  return (
    <>
      <div className="absolute -left-[2px] -top-[2px] h-[calc(100%+4px)] w-[calc(100%+4px)] pointer-events-none">
        <style>{`
        @keyframes spin {
      ...
      {/* Слой перекрывающий анимацию, оставляя только границу */}
      <div 
        className="absolute rounded-md pointer-events-none z-[1]" 
        style={{ 
          left: '2px', 
          top: '2px', 
          right: '2px', 
      ...
      {/* Содержимое узла поверх всех слоев */}
